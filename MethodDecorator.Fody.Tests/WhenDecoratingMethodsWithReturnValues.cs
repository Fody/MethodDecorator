namespace MethodDecoratorEx.Fody.Tests
{
    ...
    public class WhenDecoratingMethodsWithReturnValues : ClassTestsBase
    {
        ...
        public void ShouldNotifyOnEntryAndExit()
        {
            ...
            CheckInit("SimpleTest.InterceptingMethodsWithReturnValues",
                "SimpleTest.InterceptingMethodsWithReturnValues.ReturnsNumber");
        ...
        public void ShouldNotifyOfException()
        {
            ...
            CheckInit("SimpleTest.InterceptingMethodsWithReturnValues",
                "SimpleTest.InterceptingMethodsWithReturnValues.Throws");
            CheckEntry();
        ...
        public void ShouldReportEntryAndExitWithMultipleReturns1()
        {
            ...
            CheckInit("SimpleTest.InterceptingMethodsWithReturnValues",
                "SimpleTest.InterceptingMethodsWithReturnValues.MultipleReturns", 1);
        ...
        public void ShouldReportEntryAndExitWithMethodWithMultipleReturnsEndingWithThrow()
        {
            ...
            CheckInit("SimpleTest.InterceptingMethodsWithReturnValues",
                "SimpleTest.InterceptingMethodsWithReturnValues.MultipleReturnValuesButEndingWithThrow", 1);
        ...
        public void ShouldReportExceptionWithMethodWithMultipleReturnsEndingWithThrow()
        {
            ...
            CheckException<InvalidOperationException>("Ooops");
            CheckMethodSeq(new[]
            {Method.Init, Method.OnEnter, Method.Body, Method.Body, Method.Body, Method.OnException});
        }
    }
}