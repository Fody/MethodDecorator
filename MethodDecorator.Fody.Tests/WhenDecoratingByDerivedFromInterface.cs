namespace MethodDecoratorEx.Fody.Tests
{
    ...
    public class WhenDecoratingByDerivedFromInterface : ClassTestsBase
    {
        ...
        public void ShouldNotifyInitEntryAndExit()
        {
            ...
            CheckInit("SimpleTest.MarkedFromTheDerivedInterface",
                "MarkedFromTheDerivedInterface.CanLogInitEntryAndExit(String)", 1);
        }
        ...
        public void ShouldNotifyOnInitEntryAndException()
        {
            ...
            CheckInit("SimpleTest.MarkedFromTheDerivedInterface",
                "MarkedFromTheDerivedInterface.CanLogInitEntryAndException()");
