namespace MethodDecoratorEx.Fody.Tests
{
    ...
    public class WhenDecoratingVoidMethod : ClassTestsBase
    {
        ...
        public void ShouldNotifyOfThrownException()
        {
            ...
            CheckInit("SimpleTest.InterceptingVoidMethods",
                "SimpleTest.InterceptingVoidMethods.ThrowingInvalidOperationException");
            CheckEntry();
        ...
        public void ShouldReportOnEntryAndOnExitWithConditionalThrow()
        {
            ...
            CheckInit("SimpleTest.InterceptingVoidMethods",
                "SimpleTest.InterceptingVoidMethods.ConditionallyThrowingInvalidOperationException", 1);
            CheckEntry();
            CheckExit();
        }
        ...
        public void ShouldReportOnEntryAndOnExceptionWithConditionalThrow()
        {
            Assert.Throws<InvalidOperationException>(
                new Action(() => TestClass.ConditionallyThrowingInvalidOperationException(shouldThrow: true)));
        ...
        {
            Assert.Throws<InvalidOperationException>(
                new Action(() => TestClass.WithMultipleReturnsAndExceptions(1, shouldThrow: true)));

            CheckInit("SimpleTest.InterceptingVoidMethods",
                "SimpleTest.InterceptingVoidMethods.WithMultipleReturnsAndExceptions", 2);
            CheckEntry();
        ...
        {
            Assert.Throws<InvalidOperationException>(
                new Action(() => TestClass.WithMultipleReturnsAndExceptions(2, shouldThrow: true)));
        ...
        {
            Assert.Throws<InvalidOperationException>(
                new Action(() => TestClass.WithMultipleReturnsAndExceptions(3, shouldThrow: true)));
        ...
        public void ShouldReportEntryAndExitWithMethodWithMultipleReturnsEndingWithThrow()
        {
            ...
            CheckInit("SimpleTest.InterceptingVoidMethods",
                "SimpleTest.InterceptingVoidMethods.MultipleReturnValuesButEndingWithThrow", 1);
            CheckEntry();
        ...
        {
            Assert.Throws<InvalidOperationException>(
                new Action(() => TestClass.MultipleReturnValuesButEndingWithThrow(0)));
